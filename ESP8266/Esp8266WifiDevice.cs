...
// Implement wrapper class for OutputPort
namespace System.IO.Ports
{
    public class OutputPort
    {
        public GpioPin Pin { get; }
        //public GpioPin Pin { [MethodImpl(MethodImplOptions.InternalCall)] get; }
        public OutputPort(int pinNumber, bool InitialState = false)
        {
